...
const benefits = [
  { title: "Qualidade de Vitrine:", desc: "+200 modelos exclusivos de alto nível, prontos para impressão profissional." },
  { title: "Economia de Tempo:", desc: "Pare de criar do zero. Baixou, imprimiu, montou — e lucrou!" },
  { title: "Dia das Mães:", desc: "Lucre de R$15 a R$40 por cone nas próximas datas!" },
  { title: "Super Fácil:", desc: "Vídeo tutorial incluso. Monte em minutos, sem experiência." },
];
    ...
    <section className="bg-gradient-hero py-6 md:py-14">
      <div className="container">
        ...
        <h1 className="text-3xl md:text-5xl lg:text-6xl font-black text-center leading-[1.1] md:leading-tight mb-1.5 md:mb-4">
          ...
          <span className="text-gradient-blue">Pare de Criar do Zero — Renove Seu Catálogo em Minutos</span>
        </h1>

        <p className="text-center text-base md:text-xl font-bold text-primary mb-1 md:mb-2">
          +200 MOLDES PROFISSIONAIS <span className="font-black underline">EDITÁVEIS NO CANVA</span> — PRONTOS PARA DIA DAS MÃES
        </p>

        <p className="text-center text-foreground font-semibold text-sm md:text-lg mb-4 md:mb-6 max-w-xl mx-auto leading-snug">
          Moldes com qualidade de vitrine. Imprima, recorte, monte e lucre alto nas próximas datas!
          <span className="text-primary"> 📲 Receba no WhatsApp e E-mail na hora!</span>
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-6 items-center mb-4 md:mb-6">
          <div className="relative order-1">
            <div className="relative animate-float">
              <img
                src={heroCones}
                alt="Super Pack +200 Modelos de Cones de Coração - Prontos para Imprimir"
        ...
        <div className="flex flex-col items-center">
          ...
          >
            <span>QUERO GARANTIR MEU SUPER PACK</span>
