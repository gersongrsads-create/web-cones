...
const basicFeatures = [
  { text: "200+ Plantillas de Corazones (PDF)", included: true },
];

const basicExcluded = [
  "Formatos PNG, SVG y JPG",
  "Plantilla Editable en Canva",
  "4 Bonificaciones Exclusivas",
  "Tutorial en Video",
...
const premiumFeatures = [
  ...
  "200+ Plantillas de Corazones",
  "TODOS los Formatos: PDF, PNG, SVG y JPG",
  "Tutorial en Video",
  "⭐ 🎨 Acceso a Canva Editable (+200 Corazones)",
  "🎁 Bonificación 1: Plantilla en Blanco, Editable en Canva",
  "🎁 Bonificación 2: Pack Caja de Regalo Cuadrada",
  "🎁 Bonificación 3: Caja '8 Razones para Decir Que Sí'",
...
interface PricingSectionESProps {
  onBasicClick: () => void;
}

export const PricingSectionES = ({ onBasicClick }: PricingSectionESProps) => {
      ...
      <div className="container">
        <div className="text-center mb-6 md:mb-8">
          <span className="inline-block bg-highlight text-highlight-foreground px-4 py-1.5 rounded-full text-xs font-bold mb-3 animate-pulse">
            📅 ¡OFERTA ESPECIAL HOY! {currentDate}
          </span>
          <h2 className="text-xl md:text-3xl font-black mb-2">
            Elige Tu <span className="text-gradient-blue">Pack Perfecto</span>
          </h2>
           <p className="text-muted-foreground text-sm flex items-center justify-center gap-2">
            <Download className="w-4 h-4 text-primary" />
            ⚡ Descarga Digital Instantánea — ¡entregada a tu email!
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-5 md:gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border-2 border-muted p-5 md:p-6 shadow-soft">
            <div className="text-center mb-4">
              ...
              <p className="text-sm text-muted-foreground">Imprime y corta con tijeras</p>
            </div>
            <div className="flex justify-center mb-4">
              <img src={kitBasico} alt="Pack Básico de Plantillas de Corazones" className="w-full max-w-[220px] h-auto rounded-xl" loading="lazy" />
            </div>
          ...
          <div className="relative bg-gradient-to-br from-primary via-primary to-pink-700 rounded-2xl p-4 md:p-6 shadow-blue md:scale-105 md:-translate-y-2 overflow-hidden">
            ...
            <div className="relative text-center mb-4 md:mb-5 md:mt-6">
              ...
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-3 py-1 mt-1">
                ...
                <p className="text-xs md:text-sm text-white font-bold">🔥 350+ ventas este mes</p>
              </div>
            </div>
            ...
            <div className="relative flex justify-center mb-4 md:mb-5">
              <div className="relative w-full max-w-[280px] md:max-w-none">
                ...
                <img src={kitPremium} alt="Pack Premium de Plantillas de Corazones" className="relative w-full md:w-48 h-auto drop-shadow-2xl mx-auto rounded-xl" loading="lazy" />
            ...
            <div className="relative bg-white/10 backdrop-blur-sm rounded-lg p-2 mb-4 border border-white/20">
              <p className="text-white/90 text-xs text-center flex items-center justify-center gap-1.5">
                ⚠️ <strong>Archivos listos para imprimir</strong> — ¡Solo descarga y usa!
              </p>
            </div>
            ...
            <div className="relative text-center mb-4 md:mb-5 bg-white/15 backdrop-blur-sm rounded-xl p-3 md:p-4 border border-white/20">
              ...
              <p className="text-accent font-bold text-sm md:text-base mt-1 md:mt-2 flex items-center justify-center gap-1">
                <Zap className="w-3.5 h-3.5 md:w-4 md:h-4" />
                Todos los formatos + 4 Bonificaciones Gratis + Acceso a Canva
              </p>
            </div>
        ...
        <div className="grid grid-cols-2 gap-2 md:flex md:flex-wrap md:justify-center md:gap-3 mt-8 max-w-sm md:max-w-none mx-auto">
          ...
          <div className="flex items-center justify-center gap-1.5 bg-muted px-3 py-2 rounded-full text-sm">
            <span>💳</span>
            <span>Tarjeta o PayPal</span>
          </div>
          <div className="flex items-center justify-center gap-1.5 bg-muted px-3 py-2 rounded-full text-sm">
            <Download className="w-4 h-4 text-primary" />
            <span>Descarga Digital Instantánea</span>
          </div>
          <div className="flex items-center justify-center gap-1.5 bg-muted px-3 py-2 rounded-full text-sm">
            <span>✅</span>
        ...
        <div className="max-w-lg mx-auto mt-10 bg-gradient-hero rounded-2xl p-6 text-center">
          ...
          <h3 className="text-lg font-black mb-2 flex items-center justify-center gap-2">
            ...
            Garantía de Devolución de Dinero en 7 Días
          </h3>
          <p className="text-muted-foreground text-base">
            ¿No estás satisfecha? Devolvemos <span className="font-bold text-foreground">el 100% de tu dinero</span>, sin preguntas. ¡Cero riesgo para ti!
          </p>
        </div>
      </div>
    </section>
