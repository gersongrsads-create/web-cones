...
const tiers = [
  { daily: 2, monthly: 60, income: 2400, emoji: "🌱", label: "Side Income" },
  { daily: 3, monthly: 90, income: 3600, emoji: "🔥", label: "Part-Time" },
  { daily: 5, monthly: 150, income: 6000, emoji: "🚀", label: "Full Income" },
];

export const IncomeCalculatorSectionEN = () => {
  return (
      ...
      <div className="container max-w-2xl mx-auto px-4">
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl md:text-3xl font-black leading-tight">
            💰 How You Can Earn Between{" "}
            <span className="text-accent">$3,600</span> and{" "}
            <span className="text-accent">$6,000</span> Per Month
          </h2>
          <p className="text-muted-foreground text-sm mt-2">
            Profiting <strong className="text-foreground">$40</strong> per cone sold:
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl border-2 border-muted shadow-soft overflow-hidden">
          ...
          <div className="grid grid-cols-4 bg-foreground text-background text-[11px] md:text-sm font-bold text-center">
            ...
            <div className="py-2.5 px-2">Sales/Day</div>
            <div className="py-2.5 px-2">Sales/Mo</div>
            <div className="py-2.5 px-2">Profit/Mo</div>
          </div>
          ...
          {tiers.map((tier, i) => (
            ...
            >
              ...
              <div className="py-3.5 px-2">
                ...
                <p className="text-[10px] text-muted-foreground">{tier.daily} × 30 days</p>
              </div>
              <div className="py-3.5 px-2">
                <span className={`text-base md:text-lg font-black ${i === 1 ? "text-accent" : "text-foreground"}`}>
                  ${tier.income.toLocaleString("en-US")}
                </span>
        ...
        <div className="mt-5 bg-white/80 backdrop-blur-sm rounded-xl border border-accent/20 p-4 text-center">
          <p className="text-sm font-bold text-foreground flex items-center justify-center gap-1.5">
            ...
            With just 2-5 sales per day you can turn this pack into real income!
          </p>
        </div>
