...
const steps = [
  {
    ...
    description: "After purchase, download your files instantly — delivered straight to your email",
  ...
  },
  {
    ...
    number: "2",
    title: "Print at Home",
    description: "Use regular letter-size paper or cardstock (65lb). Your home printer works great!",
    color: "bg-primary/10 text-primary",
  },
  {
    icon: Scissors,
    number: "3",
    title: "Assemble & Sell",
    description: "Cut, fold the cone and fill with candy, flowers or anything you imagine. Profit!",
    color: "bg-accent/10 text-accent",
  },
];

export const HowItWorksSectionEN = () => {
  return (
      ...
      <div className="container">
        <div className="text-center mb-6 md:mb-8">
          ...
          <h2 className="text-xl md:text-3xl font-black">
            How Does It <span className="text-gradient-blue">Work?</span>
          </h2>
        </div>
