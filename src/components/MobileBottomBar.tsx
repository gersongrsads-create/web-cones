...
export const MobileBottomBar = () => {
  ...
  const scrollToOffer = scrollToOferta;
    ...
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-border z-50 md:hidden safe-area-bottom shadow-lg">
      <div className="flex items-center gap-2 px-3 py-2">
        ...
        <div className="flex-shrink-0 bg-highlight/20 px-2 py-1.5 rounded-lg text-center">
          <p className="text-[10px] font-bold text-highlight-foreground flex items-center gap-1">
            🔥 Sobe
          </p>
        ...
        <button
          ...
          className="flex-1 bg-accent hover:bg-accent-hover text-accent-foreground font-bold py-3 rounded-xl text-center text-base shadow-green active:scale-[0.98] transition-transform flex items-center justify-center gap-1.5 animate-cta-pulse"
        >
